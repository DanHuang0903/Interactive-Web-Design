...
function rollDice(btn){
	...
	btn.id == "btn1"? $("#point1").text(point) : $("#point2").text(point);
	btn.id == "btn1"? $("#rounds1").text(turn) : $("#rounds2").text(turn);
	btn.id == "btn1"? $("#cal1").text("(" + parseInt($("#total1").text()) + " + " + point + ")") : $("#cal2").text("(" + parseInt($("#total2").text()) + " + " + point + ")")
	...
	if(flag%2 == 0){
		...
		if(win == "Deuce")
		{
			...
			$("#winner").text(win + " Got a Larger Number in Round " + turn);
		}
		log.push(turn_log);
